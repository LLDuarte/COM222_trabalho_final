			...
			<div class="col">
				...
				<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="edicao_user/editaCadastro">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input id="idNome" name="nome" type="text" value="<?php echo $viewData['nome'];?>" class="form-control input-md" value="" required="">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input id="idSobrenome" name="sobrenome" type="text" value="<?php echo $viewData['sobrenome'];?>" class="form-control input-md" required="">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input id="idEmail" name="email" type="email" value="<?php echo $viewData['email'];?>" class="form-control input-md" disabled>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input id="idSenha" name="senha" type="password" value="<?php echo $viewData['email'];?>" class="form-control input-md" disabled>
